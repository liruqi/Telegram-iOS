...
void TLRegisterClasses()
{
    ...
    TLMetaClassStore::registerObjectClass([TLDocumentAttribute$documentAttributeSticker new]);
    TLMetaClassStore::registerObjectClass([TLDocumentAttribute$documentAttributeVideo new]);
    TLMetaClassStore::registerObjectClass([TLDocumentAttribute$documentAttributeAudio new]);
    ...
    TLMetaClassStore::registerObjectClass([TLaccount_SentChangePhoneCode$account_sentChangePhoneCode new]);
    ...
    TLMetaClassStore::registerObjectClass([TLRPCaccount_sendChangePhoneCode$account_sendChangePhoneCode new]);
